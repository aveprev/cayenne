...
public class MultiPathDataDomainConfigurationResolver extends
    ...
    private Collection<String> configurationLocations;

    public MultiPathDataDomainConfigurationResolver(
            Collection<String> configurationLocations) {
    ...
    public Collection<Resource> resolveConfigurations() {
        ...
        for (String location : configurationLocations) {
            configurations.addAll(findConfigurationResources(location));
        }
